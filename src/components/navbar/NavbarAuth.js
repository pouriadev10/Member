...
import { MemberpointLogo } from "../../assets/img/favicon.png";
  ...
  let brand = (
    <Link
      ...
      <Stack direction='row' spacing='12px' align='center' justify='center'>
        <MemberpointLogo h='26px' w='175px' color={logoColor} />
      </Stack>
  ...
  if (props.secondary === true) {
    brand = (
      <Link
        ...
        alignItems='center'
        color={mainText}>
        <MemberpointLogo h='26px' w='175px' my='32px' color={logoColor} />
      </Link>
    );
